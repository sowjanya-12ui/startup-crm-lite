  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        onClick={toggleTheme}
        type="button"
        className="group relative flex h-7 w-12 shrink-0 cursor-pointer rounded-full bg-surface p-0.5 transition-colors duration-300 focus:outline-none"
        aria-label="Toggle Theme Mode"
      >
        {/* Sliding circle */}
        <span
          className={`flex h-6 w-6 transform items-center justify-center rounded-full bg-surface text-amber-500 shadow-sm transition-all duration-300  dark:text-primary ${
